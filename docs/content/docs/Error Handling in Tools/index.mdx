...
- **<u>[Retries](/docs/Error%20Handling%20in%20Tools/retries)</u>**  
  Automatically retry failing tools with optional exponential backoff.

- **<u>[Timeouts](/docs/Error%20Handling%20in%20Tools/timeout)</u>**  
  Prevent long-running or hanging operations.

- **<u>[Validation Failures](/docs/Structured%20Output/tools-output#validating-tool-output-with-schema)</u>**  
