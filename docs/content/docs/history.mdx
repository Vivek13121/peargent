...
Because history supports many advanced capabilities, custom storage backends, manual thread control, serialization, and low-level message operations, listing every option here would make this page too large. For deeper configuration and advanced usage, see **<u>Advanced Features
</u>**.
...
```
To create a custom storage backend, refer to **<u>[Custom Storage Backend](/docs/history#custom-storage-backend)</u>**.
...
Learn more about Advance Features in **<u>Advanced Features</u>**.
